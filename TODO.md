# A4 Aluminium Website Development TODO

## Completed Tasks
- [x] Create index.html with homepage layout
- [x] Create products.html for products page
- [x] Create styles.css for custom styling
- [x] Create script.js for form handling and smooth scrolling
- [x] Add Bootstrap for responsive design
...
- [ ] Replace placeholder images with actual photos:
  - shop.png (done)
  - placeholder-product1.jpg, placeholder-product2.jpg, placeholder-product3.jpg
  - placeholder-work1.jpg, placeholder-work2.jpg, placeholder-work3.jpg
- [x] Update products.html with actual products from Excel sheet
- [x] Replace placeholder Instagram tag with actual tag
- [x] Test website functionality
- [ ] Deploy website if needed
